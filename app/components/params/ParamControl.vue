...
/**
 * Dispatch SANS wrapper label/tooltip. Utilisé par les composants qui
 * portent eux-mêmes leur propre header (FactorizedTraitRow,
 * CanonicalParamRow). `ParamField.vue` reste pour les usages standards
 * qui veulent label + contrôle d'un coup.
 */
